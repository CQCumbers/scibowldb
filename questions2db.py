...
rounds_path = 'official/text' # A folder of OCR'd Science Bowl sample rounds
questions = []
regex = re.compile(r'TOSS-UP\s*'  # type of question
                    r'(\d+)(?:\)|\.)\s*'   # question number
                    r'(PHYSICS|GENERAL SCIENCE|ENERGY|EARTH AND SPACE|EARTH SCIENCE|CHEMISTRY|BIOLOGY|ASTRONOMY|MATH|COMPUTER SCIENCE) '   # category of question, no MATH because OCR problems
